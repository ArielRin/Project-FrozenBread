    ...
    <footer style={{ backgroundColor: '#000', color: 'white', textAlign: 'center', padding: '20px 0' }}>
      <Flex direction="column" alignItems="center">
          ...
          <Box padding="5px">
            <VStack align="center" color="white">
              <ChakraLink href="https://dexscreener.com/bsc/0x48087ac66e205063fb3462f873e19e802e184992" isExternal>
                <Image src="/images/footer/dexscrn.png" alt="Dexscreener Logo" width="220px" />
              </ChakraLink>
            </VStack>
          </Box>
          ...
          <Box padding="5px">
            <VStack align="center" color="white">
              <ChakraLink href="https://t.me/+EcHpneQgjthkMDRk" isExternal>
                <Image src="/images/footer/telegram.png" alt="Telegram Logo" width="220px" />
              </ChakraLink>
            </VStack>
          </Box>
          ...
          <Box padding="5px">
            <VStack align="center" color="white">
              <ChakraLink href="https://x.com/ToastEcosystem" isExternal>
                <Image src="/images/footer/x.png" alt="Twitter Logo" width="220px" />
              </ChakraLink>
            </VStack>
          </Box>
          ...
          <Box padding="5px">
            <VStack align="center" color="white">
              <ChakraLink href="https://bscscan.com/address/0x0e88A6839cf02f23fFE16E23cBB723FE066f8b14#code" isExternal>
                <Image src="/images/footer/bscscan.png" alt="Bscscan Logo" width="220px" />
              </ChakraLink>
            </VStack>
          </Box>
        ...
        <ChakraLink href="toastecosystem.online" isExternal>
          <Image src="/images/footer/logotoast.png" alt="Toast Logo" width="220px" />
        </ChakraLink>
