import {
  ...
  require_events,
  require_ieee754
} from "./chunk-WKVDZGTG.js";
import {
  require_copy_to_clipboard
} from "./chunk-CZSY3RYV.js";
import {
  require_dijkstra
} from "./chunk-MV2TE2NG.js";
import {
  require_eventemitter3
} from "./chunk-26J4KEB6.js";
import {
  require_sha3
  ...
  "node_modules/@walletconnect/environment/node_modules/tslib/tslib.js"(exports, module) {
    ...
    (function(factory) {
      ...
      var extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d4, b2) {
        ...
        for (var p4 in b2)
          if (b2.hasOwnProperty(p4))
            d4[p4] = b2[p4];
      };
      __extends = function(d4, b2) {
        extendStatics(d4, b2);
        function __() {
          this.constructor = d4;
        }
      ...
      __createBinding = function(o6, m4, k3, k22) {
        if (k22 === void 0)
          k22 = k3;
        o6[k22] = m4[k3];
      };
      ...
      __values = function(o6) {
        var s3 = typeof Symbol === "function" && Symbol.iterator, m4 = s3 && o6[s3], i3 = 0;
        if (m4)
          return m4.call(o6);
      ...
      __read = function(o6, n3) {
        var m4 = typeof Symbol === "function" && o6[Symbol.iterator];
        if (!m4)
          return o6;
        var i3 = m4.call(o6), r4, ar = [], e4;
        try {
          while ((n3 === void 0 || n3-- > 0) && !(r4 = i3.next()).done)
            ar.push(r4.value);
        } catch (error) {
          e4 = { error };
        } finally {
          ...
          if (g4[n3])
            i3[n3] = function(v4) {
              return new Promise(function(a3, b2) {
                q3.push([n3, v4, a3, b2]) > 1 || resume(n3, v4);
              });
            };
        }
      ...
      __asyncDelegator = function(o6) {
        ...
        function verb(n3, f4) {
          i3[n3] = o6[n3] ? function(v4) {
            return (p4 = !p4) ? { value: __await(o6[n3](v4)), done: n3 === "return" } : f4 ? f4(v4) : v4;
          } : f4;
        }
      };
      __asyncValues = function(o6) {
        if (!Symbol.asyncIterator)
          throw new TypeError("Symbol.asyncIterator is not defined.");
        var m4 = o6[Symbol.asyncIterator], i3;
        return m4 ? m4.call(o6) : (o6 = typeof __values === "function" ? __values(o6) : o6[Symbol.iterator](), i3 = {}, verb("next"), verb("throw"), verb("return"), i3[Symbol.asyncIterator] = function() {
          return this;
        }, i3);
        function verb(n3) {
          i3[n3] = o6[n3] && function(v4) {
            return new Promise(function(resolve, reject) {
              v4 = o6[n3](v4), settle(resolve, reject, v4.done, v4.value);
            });
          };
        }
...
// node_modules/@walletconnect/window-metadata/node_modules/@walletconnect/window-getters/dist/cjs/index.js
var require_cjs2 = __commonJS({
  "node_modules/@walletconnect/window-metadata/node_modules/@walletconnect/window-getters/dist/cjs/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var init_browser = __esm({
  "node_modules/@walletconnect/browser-utils/dist/esm/browser.js"() {
    ...
    windowGetters = __toESM(require_cjs4());
    init_es();
...
var safeJsonParse3, safeJsonStringify3;
var init_json = __esm({
  "node_modules/@walletconnect/browser-utils/dist/esm/json.js"() {
    init_esm();
    safeJsonParse3 = safeJsonParse2;
    safeJsonStringify3 = safeJsonStringify2;
  }
});
...
__export(esm_exports3, {
  ...
  safeJsonStringify: () => safeJsonStringify3,
    ...
    (function(module2, exports2) {
      ...
      BN2.prototype._parseHex = function _parseHex(number, start) {
        ...
        for (i3 = number.length - 6, j4 = 0; i3 >= start; i3 -= 6) {
          ...
          this.words[j4] |= w5 << off & 67108863;
          this.words[j4 + 1] |= w5 >>> 26 - off & 4194303;
          off += 24;
          if (off >= 26) {
            off -= 26;
            j4++;
      ...
      BN2.prototype.toString = function toString(base, padding) {
        ...
        if (base === (base | 0) && base >= 2 && base <= 36) {
          ...
          c5.negative = 0;
          while (!c5.isZero()) {
            var r4 = c5.modn(groupBase).toString(base);
      ...
      BN2.prototype.iadd = function iadd(num) {
        ...
        var carry = 0;
        for (var i3 = 0; i3 < b2.length; i3++) {
          r4 = (a3.words[i3] | 0) + (b2.words[i3] | 0) + carry;
      ...
      FFTM.prototype.makeRBT = function makeRBT(N3) {
        var t3 = new Array(N3);
        var l4 = BN2.prototype._countBits(N3) - 1;
        for (var i3 = 0; i3 < N3; i3++) {
          t3[i3] = this.revBin(i3, l4, N3);
        }
        return t3;
      };
      FFTM.prototype.revBin = function revBin(x3, l4, N3) {
        if (x3 === 0 || x3 === N3 - 1)
          return x3;
        var rb = 0;
        ...
        for (var s3 = 1; s3 < N3; s3 <<= 1) {
          ...
          for (var p4 = 0; p4 < N3; p4 += l4) {
            ...
            for (var j4 = 0; j4 < s3; j4++) {
              var re = rtws[p4 + j4];
              var ie = itws[p4 + j4];
              var ro = rtws[p4 + j4 + s3];
              var io = itws[p4 + j4 + s3];
      ...
      FFTM.prototype.normalize13b = function normalize13b(ws, N3) {
        var carry = 0;
        for (var i3 = 0; i3 < N3 / 2; i3++) {
          var w5 = Math.round(ws[2 * i3 + 1] / N3) * 8192 + Math.round(ws[2 * i3] / N3) + carry;
          ws[i3] = w5 & 67108863;
          if (w5 < 67108864) {
            carry = 0;
          } else {
      ...
      BN2.prototype.pow = function pow(num) {
        ...
        if (++i3 < w5.length) {
          for (var q3 = res.sqr(); i3 < w5.length; i3++, q3 = q3.sqr()) {
            if (w5[i3] === 0)
              continue;
            res = res.mul(q3);
          }
      ...
      BN2.prototype.iushln = function iushln(bits) {
        ...
        if (r4 !== 0) {
          ...
          for (i3 = 0; i3 < this.length; i3++) {
            ...
            var c5 = (this.words[i3] | 0) - newCarry << r4;
      ...
      BN2.prototype._wordDiv = function _wordDiv(num, mode) {
        ...
        var diff = a3.clone()._ishlnsubmul(b2, 1, m4);
        if (diff.negative === 0) {
          a3 = diff;
          if (q3) {
            q3.words[m4] = 1;
        ...
        for (var j4 = m4 - 1; j4 >= 0; j4--) {
          var qj = (a3.words[b2.length + j4] | 0) * 67108864 + (a3.words[b2.length + j4 - 1] | 0);
          qj = Math.min(qj / bhi | 0, 67108863);
          a3._ishlnsubmul(b2, qj, j4);
          while (a3.negative !== 0) {
            qj--;
            a3.negative = 0;
            a3._ishlnsubmul(b2, 1, j4);
            if (!a3.isZero()) {
              a3.negative ^= 1;
            }
          }
      ...
      Red.prototype.sqrt = function sqrt(a3) {
        ...
        while (t3.cmp(one) !== 0) {
          ...
          assert2(i3 < m4);
          var b2 = this.pow(c5, new BN2(1).iushln(m4 - i3 - 1));
          r4 = r4.redMul(b2);
          c5 = b2.redSqr();
          t3 = t3.redMul(c5);
          m4 = i3;
    ...
    exports.getPositions = function getPositions(version) {
      ...
      for (var i3 = 0; i3 < posLength; i3++) {
        for (var j4 = 0; j4 < posLength; j4++) {
          if (i3 === 0 && j4 === 0 || i3 === 0 && j4 === posLength - 1 || i3 === posLength - 1 && j4 === 0) {
            continue;
          }
...
var require_byte_data = __commonJS({
  "node_modules/@walletconnect/qrcode-modal/node_modules/qrcode/lib/core/byte-data.js"(exports, module) {
    ...
    ByteData.prototype.write = function(bitBuffer) {
      for (var i3 = 0, l4 = this.data.length; i3 < l4; i3++) {
        ...
        for (var r4 = -1; r4 <= 7; r4++) {
          ...
          for (var c5 = -1; c5 <= 7; c5++) {
            if (col + c5 <= -1 || size <= col + c5)
              continue;
            if (r4 >= 0 && r4 <= 6 && (c5 === 0 || c5 === 6) || c5 >= 0 && c5 <= 6 && (r4 === 0 || r4 === 6) || r4 >= 2 && r4 <= 4 && c5 >= 2 && c5 <= 4) {
              matrix.set(row + r4, col + c5, true, true);
            } else {
              matrix.set(row + r4, col + c5, false, true);
            }
          }
        }
      }
      ...
      for (var i3 = 0; i3 < pos.length; i3++) {
        ...
        for (var r4 = -2; r4 <= 2; r4++) {
          for (var c5 = -2; c5 <= 2; c5++) {
            if (r4 === -2 || r4 === 2 || c5 === -2 || c5 === 2 || r4 === 0 && c5 === 0) {
              matrix.set(row + r4, col + c5, true, true);
            } else {
              matrix.set(row + r4, col + c5, false, true);
            }
...
function h(n3, l4, u3) {
  var i3, t3 = arguments, r4 = {};
  for (i3 in l4)
    "key" !== i3 && "ref" !== i3 && (r4[i3] = l4[i3]);
  if (arguments.length > 3)
    for (u3 = [u3], i3 = 3; i3 < arguments.length; i3++)
      u3.push(t3[i3]);
  if (null != u3 && (r4.children = u3), "function" == typeof n3 && null != n3.defaultProps)
    for (i3 in n3.defaultProps)
      void 0 === r4[i3] && (r4[i3] = n3.defaultProps[i3]);
  return p2(n3, r4, l4 && l4.key, l4 && l4.ref, null);
}
function p2(l4, u3, i3, t3, r4) {
  var o6 = { type: l4, props: u3, key: i3, ref: t3, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: r4 };
  return null == r4 && (o6.__v = o6), n2.vnode && n2.vnode(o6), o6;
}
function y() {
  return {};
}
...
function w2(n3, l4) {
  if (null == l4)
    return n3.__ ? w2(n3.__, n3.__.__k.indexOf(n3) + 1) : null;
...
function g2(l4) {
  (!l4.__d && (l4.__d = true) && u.push(l4) && !i++ || r2 !== n2.debounceRendering) && ((r2 = n2.debounceRendering) || t)(_);
}
function _() {
  for (var n3; i = u.length; )
    n3 = u.sort(function(n4, l4) {
      ...
      var l4, u3, i3, t3, r4, o6, f4;
      n4.__d && (o6 = (r4 = (l4 = n4).__v).__e, (f4 = l4.__P) && (u3 = [], (i3 = a({}, r4)).__v = i3, t3 = A(f4, r4, i3, l4.__n, void 0 !== f4.ownerSVGElement, null, u3, null == o6 ? w2(r4) : o6), T2(u3, r4), t3 != o6 && k(r4)));
    });
}
function b(n3, l4, u3, i3, t3, r4, o6, f4, s3) {
  var a3, h3, p4, y3, d4, m4, k3, g4 = u3 && u3.__k || c3, _4 = g4.length;
  if (f4 == e2 && (f4 = null != r4 ? r4[0] : _4 ? w2(u3, 0) : null), a3 = 0, l4.__k = x(l4.__k, function(u4) {
    if (null != u4) {
      if (u4.__ = l4, u4.__b = l4.__b + 1, null === (p4 = g4[a3]) || p4 && u4.key == p4.key && u4.type === p4.type)
        g4[a3] = void 0;
      else
        for (h3 = 0; h3 < _4; h3++) {
          if ((p4 = g4[h3]) && u4.key == p4.key && u4.type === p4.type) {
            g4[h3] = void 0;
            break;
          }
          p4 = null;
        }
      if (y3 = A(n3, u4, p4 = p4 || e2, i3, t3, r4, o6, f4, s3), (h3 = u4.ref) && p4.ref != h3 && (k3 || (k3 = []), p4.ref && k3.push(p4.ref, null, u4), k3.push(h3, u4.__c || y3, u4)), null != y3) {
        var c5;
        if (null == m4 && (m4 = y3), void 0 !== u4.__d)
          c5 = u4.__d, u4.__d = void 0;
        else if (r4 == p4 || y3 != f4 || null == y3.parentNode) {
          n:
            if (null == f4 || f4.parentNode !== n3)
              n3.appendChild(y3), c5 = null;
            else {
              for (d4 = f4, h3 = 0; (d4 = d4.nextSibling) && h3 < _4; h3 += 2)
                if (d4 == y3)
                  break n;
              n3.insertBefore(y3, f4), c5 = f4;
            }
          "option" == l4.type && (n3.value = "");
        }
        f4 = void 0 !== c5 ? c5 : y3.nextSibling, "function" == typeof l4.type && (l4.__d = f4);
      } else
        f4 && p4.__e == f4 && f4.parentNode != n3 && (f4 = w2(p4));
    }
    return a3++, u4;
  }), l4.__e = m4, null != r4 && "function" != typeof l4.type)
    for (a3 = r4.length; a3--; )
      null != r4[a3] && v2(r4[a3]);
  for (a3 = _4; a3--; )
    null != g4[a3] && D(g4[a3], g4[a3]);
  if (k3)
    for (a3 = 0; a3 < k3.length; a3++)
      j2(k3[a3], k3[++a3], k3[++a3]);
}
function x(n3, l4, u3) {
  if (null == u3 && (u3 = []), null == n3 || "boolean" == typeof n3)
    ...
    u3.push(l4 ? l4("string" == typeof n3 || "number" == typeof n3 ? p2(null, n3, null, null, n3) : null != n3.__e || null != n3.__c ? p2(n3.type, n3.props, n3.key, null, n3.__v) : n3) : n3);
  return u3;
}
function P2(n3, l4, u3, i3, t3) {
  var r4;
  for (r4 in u3)
    "children" === r4 || "key" === r4 || r4 in l4 || N(n3, r4, null, u3[r4], i3);
  for (r4 in l4)
    t3 && "function" != typeof l4[r4] || "children" === r4 || "key" === r4 || "value" === r4 || "checked" === r4 || u3[r4] === l4[r4] || N(n3, r4, l4[r4], u3[r4], i3);
}
function C(n3, l4, u3) {
  "-" === l4[0] ? n3.setProperty(l4, u3) : n3[l4] = "number" == typeof u3 && false === s.test(l4) ? u3 + "px" : null == u3 ? "" : u3;
}
function N(n3, l4, u3, i3, t3) {
  var r4, o6, f4, e4, c5;
  if (t3 ? "className" === l4 && (l4 = "class") : "class" === l4 && (l4 = "className"), "style" === l4)
    if (r4 = n3.style, "string" == typeof u3)
      r4.cssText = u3;
    else {
      if ("string" == typeof i3 && (r4.cssText = "", i3 = null), i3)
        for (e4 in i3)
          u3 && e4 in u3 || C(r4, e4, "");
      if (u3)
        for (c5 in u3)
          i3 && u3[c5] === i3[c5] || C(r4, c5, u3[c5]);
    }
  else
    "o" === l4[0] && "n" === l4[1] ? (o6 = l4 !== (l4 = l4.replace(/Capture$/, "")), f4 = l4.toLowerCase(), l4 = (f4 in n3 ? f4 : l4).slice(2), u3 ? (i3 || n3.addEventListener(l4, z, o6), (n3.l || (n3.l = {}))[l4] = u3) : n3.removeEventListener(l4, z, o6)) : "list" !== l4 && "tagName" !== l4 && "form" !== l4 && "type" !== l4 && "size" !== l4 && !t3 && l4 in n3 ? n3[l4] = null == u3 ? "" : u3 : "function" != typeof u3 && "dangerouslySetInnerHTML" !== l4 && (l4 !== (l4 = l4.replace(/^xlink:?/, "")) ? null == u3 || false === u3 ? n3.removeAttributeNS("http://www.w3.org/1999/xlink", l4.toLowerCase()) : n3.setAttributeNS("http://www.w3.org/1999/xlink", l4.toLowerCase(), u3) : null == u3 || false === u3 && !/^ar/.test(l4) ? n3.removeAttribute(l4) : n3.setAttribute(l4, u3));
}
function z(l4) {
  this.l[l4.type](n2.event ? n2.event(l4) : l4);
}
function A(l4, u3, i3, t3, r4, o6, f4, e4, c5) {
  var s3, v4, h3, p4, y3, w5, k3, g4, _4, x3, P4 = u3.type;
  ...
  try {
    n:
      if ("function" == typeof P4) {
        if (g4 = u3.props, _4 = (s3 = P4.contextType) && t3[s3.__c], x3 = s3 ? _4 ? _4.props.value : s3.__ : t3, i3.__c ? k3 = (v4 = u3.__c = i3.__c).__ = v4.__E : ("prototype" in P4 && P4.prototype.render ? u3.__c = v4 = new P4(g4, x3) : (u3.__c = v4 = new m2(g4, x3), v4.constructor = P4, v4.render = E2), _4 && _4.sub(v4), v4.props = g4, v4.state || (v4.state = {}), v4.context = x3, v4.__n = t3, h3 = v4.__d = true, v4.__h = []), null == v4.__s && (v4.__s = v4.state), null != P4.getDerivedStateFromProps && (v4.__s == v4.state && (v4.__s = a({}, v4.__s)), a(v4.__s, P4.getDerivedStateFromProps(g4, v4.__s))), p4 = v4.props, y3 = v4.state, h3)
          null == P4.getDerivedStateFromProps && null != v4.componentWillMount && v4.componentWillMount(), null != v4.componentDidMount && v4.__h.push(v4.componentDidMount);
        else {
          if (null == P4.getDerivedStateFromProps && g4 !== p4 && null != v4.componentWillReceiveProps && v4.componentWillReceiveProps(g4, x3), !v4.__e && null != v4.shouldComponentUpdate && false === v4.shouldComponentUpdate(g4, v4.__s, x3) || u3.__v === i3.__v && !v4.__) {
            for (v4.props = g4, v4.state = v4.__s, u3.__v !== i3.__v && (v4.__d = false), v4.__v = u3, u3.__e = i3.__e, u3.__k = i3.__k, v4.__h.length && f4.push(v4), s3 = 0; s3 < u3.__k.length; s3++)
          ...
          null != v4.componentWillUpdate && v4.componentWillUpdate(g4, v4.__s, x3), null != v4.componentDidUpdate && v4.__h.push(function() {
            v4.componentDidUpdate(p4, y3, w5);
          });
        }
        v4.context = x3, v4.props = g4, v4.state = v4.__s, (s3 = n2.__r) && s3(u3), v4.__d = false, v4.__v = u3, v4.__P = l4, s3 = v4.render(v4.props, v4.state, v4.context), u3.__k = null != s3 && s3.type == d2 && null == s3.key ? s3.props.children : Array.isArray(s3) ? s3 : [s3], null != v4.getChildContext && (t3 = a(a({}, t3), v4.getChildContext())), h3 || null == v4.getSnapshotBeforeUpdate || (w5 = v4.getSnapshotBeforeUpdate(p4, y3)), b(l4, u3, i3, t3, r4, o6, f4, e4, c5), v4.base = u3.__e, v4.__h.length && f4.push(v4), k3 && (v4.__E = v4.__ = null), v4.__e = false;
      } else
        null == o6 && u3.__v === i3.__v ? (u3.__k = i3.__k, u3.__e = i3.__e) : u3.__e = $(i3.__e, u3, i3, t3, r4, o6, f4, c5);
    (s3 = n2.diffed) && s3(u3);
  } catch (l5) {
    u3.__v = null, n2.__e(l5, u3, i3);
  }
  return u3.__e;
}
function T2(l4, u3) {
  n2.__c && n2.__c(u3, l4), l4.some(function(u4) {
    try {
      l4 = u4.__h, u4.__h = [], l4.some(function(n3) {
        n3.call(u4);
      });
    } catch (l5) {
      n2.__e(l5, u4.__v);
...
function $(n3, l4, u3, i3, t3, r4, o6, f4) {
  var s3, a3, v4, h3, p4, y3 = u3.props, d4 = l4.props;
  if (t3 = "svg" === l4.type || t3, null != r4) {
    for (s3 = 0; s3 < r4.length; s3++)
      if (null != (a3 = r4[s3]) && ((null === l4.type ? 3 === a3.nodeType : a3.localName === l4.type) || n3 == a3)) {
        n3 = a3, r4[s3] = null;
        break;
      }
  }
  if (null == n3) {
    ...
    n3 = t3 ? document.createElementNS("http://www.w3.org/2000/svg", l4.type) : document.createElement(l4.type, d4.is && { is: d4.is }), r4 = null, f4 = false;
  }
  if (null === l4.type)
    y3 !== d4 && n3.data != d4 && (n3.data = d4);
  else {
    if (null != r4 && (r4 = c3.slice.call(n3.childNodes)), v4 = (y3 = u3.props || e2).dangerouslySetInnerHTML, h3 = d4.dangerouslySetInnerHTML, !f4) {
      if (y3 === e2)
        for (y3 = {}, p4 = 0; p4 < n3.attributes.length; p4++)
          y3[n3.attributes[p4].name] = n3.attributes[p4].value;
      (h3 || v4) && (h3 && v4 && h3.__html == v4.__html || (n3.innerHTML = h3 && h3.__html || ""));
    }
    P2(n3, d4, y3, t3, f4), h3 ? l4.__k = [] : (l4.__k = l4.props.children, b(n3, l4, u3, i3, "foreignObject" !== l4.type && t3, r4, o6, e2, f4)), f4 || ("value" in d4 && void 0 !== (s3 = d4.value) && s3 !== n3.value && N(n3, "value", s3, y3.value, false), "checked" in d4 && void 0 !== (s3 = d4.checked) && s3 !== n3.checked && N(n3, "checked", s3, y3.checked, false));
  }
  return n3;
}
function j2(l4, u3, i3) {
  try {
    "function" == typeof l4 ? l4(u3) : l4.current = u3;
  } catch (l5) {
    n2.__e(l5, i3);
  }
}
function D(l4, u3, i3) {
  var t3, r4, o6;
  if (n2.unmount && n2.unmount(l4), (t3 = l4.ref) && (t3.current && t3.current !== l4.__e || j2(t3, null, u3)), i3 || "function" == typeof l4.type || (i3 = null != (r4 = l4.__e)), l4.__e = l4.__d = void 0, null != (t3 = l4.__c)) {
...
function E2(n3, l4, u3) {
  return this.constructor(n3, u3);
}
function H(l4, u3, i3) {
  var t3, r4, f4;
  n2.__ && n2.__(l4, u3), r4 = (t3 = i3 === o4) ? null : i3 && i3.__k || u3.__k, l4 = h(d2, null, [l4]), f4 = [], A(u3, (t3 ? u3 : i3 || u3).__k = l4, r4 || e2, e2, void 0 !== u3.ownerSVGElement, i3 && !t3 ? [i3] : r4 ? null : c3.slice.call(u3.childNodes), f4, i3 || e2, t3), T2(f4, l4);
}
function I(n3, l4) {
  H(n3, l4, o4);
}
function L2(n3, l4) {
  var u3, i3;
  for (i3 in l4 = a(a({}, n3.props), l4), arguments.length > 2 && (l4.children = c3.slice.call(arguments, 2)), u3 = {}, l4)
    "key" !== i3 && "ref" !== i3 && (u3[i3] = l4[i3]);
  return p2(n3.type, u3, l4.key || n3.key, l4.ref || n3.ref, null);
}
function M(n3) {
  var l4 = {}, u3 = { __c: "__cC" + f2++, __: n3, Consumer: function(n4, l5) {
    return n4.children(l5);
  }, Provider: function(n4) {
    var i3, t3 = this;
    return this.getChildContext || (i3 = [], this.getChildContext = function() {
      return l4[u3.__c] = t3, l4;
    }, this.shouldComponentUpdate = function(n5) {
      t3.props.value !== n5.value && i3.some(function(l5) {
        l5.context = n5.value, g2(l5);
      });
    }, this.sub = function(n5) {
      i3.push(n5);
      var l5 = n5.componentWillUnmount;
      n5.componentWillUnmount = function() {
        i3.splice(i3.indexOf(n5), 1), l5 && l5.call(n5);
      };
    }), n4.children;
  } };
  return u3.Consumer.contextType = u3, u3.Provider.__ = u3, u3;
}
var n2, l2, u, i, t, r2, o4, f2, e2, c3, s;
var init_preact_module = __esm({
  "node_modules/preact/dist/preact.module.js"() {
    e2 = {};
    c3 = [];
    s = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord/i;
    n2 = { __e: function(n3, l4) {
      for (var u3, i3; l4 = l4.__; )
        if ((u3 = l4.__c) && !u3.__)
          try {
    ...
    }, m2.prototype.setState = function(n3, l4) {
      var u3;
      u3 = this.__s !== this.state ? this.__s : this.__s = a({}, this.state), "function" == typeof n3 && (n3 = n3(u3, this.props)), n3 && a(u3, n3), null != n3 && this.__v && (l4 && this.__h.push(l4), g2(this));
    }, m2.prototype.forceUpdate = function(n3) {
      this.__v && (this.__e = true, n3 && this.__h.push(n3), g2(this));
    }, m2.prototype.render = d2, u = [], i = 0, t = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, o4 = e2, f2 = 0;
  }
});

// node_modules/preact/hooks/dist/hooks.module.js
function v3(t3, r4) {
  n2.__h && n2.__h(u2, t3, i2 || r4), i2 = 0;
  var o6 = u2.__H || (u2.__H = { __: [], __h: [] });
  return t3 >= o6.__.length && o6.__.push({}), o6.__[t3];
}
function m3(n3) {
  return i2 = 1, p3(E3, n3);
}
function p3(n3, r4, i3) {
  var o6 = v3(t2++, 2);
  return o6.__c || (o6.__c = u2, o6.__ = [i3 ? i3(r4) : E3(void 0, r4), function(t3) {
    var u3 = n3(o6.__[0], t3);
    o6.__[0] !== u3 && (o6.__[0] = u3, o6.__c.setState({}));
  }]), o6.__;
}
function l3(r4, i3) {
  var o6 = v3(t2++, 3);
  !n2.__s && x2(o6.__H, i3) && (o6.__ = r4, o6.__H = i3, u2.__H.__h.push(o6));
}
function y2(r4, i3) {
  var o6 = v3(t2++, 4);
  !n2.__s && x2(o6.__H, i3) && (o6.__ = r4, o6.__H = i3, u2.__h.push(o6));
}
function d3(n3) {
...
function s2(n3, t3, u3) {
  i2 = 6, y2(function() {
    "function" == typeof n3 ? n3(t3()) : n3 && (n3.current = t3());
  }, null == u3 ? u3 : u3.concat(n3));
}
function h2(n3, u3) {
  var r4 = v3(t2++, 7);
  return x2(r4.__H, u3) ? (r4.__H = u3, r4.__h = n3, r4.__ = n3()) : r4.__;
}
function T3(n3, t3) {
...
function w3(n3) {
  var r4 = u2.context[n3.__c], i3 = v3(t2++, 9);
  return i3.__c = n3, r4 ? (null == i3.__ && (i3.__ = true, r4.sub(u2)), r4.props.value) : n3.__;
}
function A2(t3, u3) {
  n2.useDebugValue && n2.useDebugValue(u3 ? u3(t3) : t3);
}
function F(n3) {
  var r4 = v3(t2++, 10), i3 = m3();
  return r4.__ = n3, u2.componentDidCatch || (u2.componentDidCatch = function(n4) {
    r4.__ && r4.__(n4), i3[1](n4);
  }), [i3[0], function() {
    i3[1](void 0);
  }];
}
function _2() {
  o5.some(function(t3) {
    if (t3.__P)
      try {
        t3.__H.__h.forEach(g3), t3.__H.__h.forEach(q), t3.__H.__h = [];
      } catch (u3) {
        return t3.__H.__h = [], n2.__e(u3, t3.__v), true;
      }
  }), o5 = [];
}
function g3(n3) {
...
function x2(n3, t3) {
  return !n3 || t3.some(function(t4, u3) {
    return t4 !== n3[u3];
  });
}
function E3(n3, t3) {
...
var t2, u2, r3, i2, o5, c4, f3, e3, a2;
var init_hooks_module = __esm({
  "node_modules/preact/hooks/dist/hooks.module.js"() {
    ...
    a2 = n2.unmount;
    n2.__r = function(n3) {
      c4 && c4(n3), t2 = 0, (u2 = n3.__c).__H && (u2.__H.__h.forEach(g3), u2.__H.__h.forEach(q), u2.__H.__h = []);
    }, n2.diffed = function(t3) {
      f3 && f3(t3);
      var u3 = t3.__c;
      if (u3) {
        var i3 = u3.__H;
        i3 && i3.__h.length && (1 !== o5.push(u3) && r3 === n2.requestAnimationFrame || ((r3 = n2.requestAnimationFrame) || function(n3) {
          var t4, u4 = function() {
            clearTimeout(r4), cancelAnimationFrame(t4), setTimeout(n3);
          }, r4 = setTimeout(u4, 100);
          "undefined" != typeof window && (t4 = requestAnimationFrame(u4));
        })(_2));
      }
    }, n2.__c = function(t3, u3) {
      u3.some(function(t4) {
        try {
...
function _3(n3, t3) {
  function e4(n4) {
    ...
    return !r5 && e5 && (e5.call ? e5(null) : e5.current = null), t3 ? !t3(this.props, n4) || !r5 : w4(this.props, n4);
  }
  function r4(t4) {
    return this.shouldComponentUpdate = e4, h(n3, E4({}, t4));
  }
...
function S(n3) {
  function t3(t4) {
    var e4 = E4({}, t4);
    return delete e4.ref, n3(e4, t4.ref);
  }
...
function j3(n3) {
  var t3 = this, e4 = n3.container, r4 = h(W, { context: t3.context }, n3.vnode);
  return t3.s && t3.s !== e4 && (t3.v.parentNode && t3.s.removeChild(t3.v), D(t3.h), t3.p = false), n3.vnode ? t3.p ? (e4.__k = t3.__k, H(r4, e4), t3.__k = e4.__k) : (t3.v = document.createTextNode(""), I("", e4), e4.appendChild(t3.v), t3.p = true, t3.s = e4, H(r4, e4, t3.v), t3.__k = t3.v.__k) : t3.p && (t3.v.parentNode && t3.s.removeChild(t3.v), D(t3.h)), t3.h = r4, t3.componentWillUnmount = function() {
    t3.v.parentNode && t3.s.removeChild(t3.v), D(t3.h);
  }, null;
}
function z2(n3, t3) {
  return h(j3, { vnode: n3, container: t3 });
}
function T4(n3, t3, e4) {
  if (null == t3.__k)
    for (; t3.firstChild; )
      t3.removeChild(t3.firstChild);
  return H(n3, t3), "function" == typeof e4 && e4(), n3 ? n3.__c : null;
}
function V(n3, t3, e4) {
  return I(n3, t3), "function" == typeof e4 && e4(), n3 ? n3.__c : null;
}
function I2(n3, t3) {
...
var C2, A3, k2, R, F2, P3, W, D2, H2, Z, $2, q2, B, Y, compat_module_default;
var init_compat_module = __esm({
  "node_modules/preact/compat/dist/compat.module.js"() {
    ...
    C2 = function(n3) {
      ...
      function r4(t4) {
        var e5;
        return (e5 = n3.call(this, t4) || this).isPureReactComponent = true, e5;
      }
      return e4 = n3, (t3 = r4).prototype = Object.create(e4.prototype), t3.prototype.constructor = t3, t3.__proto__ = e4, r4.prototype.shouldComponentUpdate = function(n4, t4) {
        return w4(this.props, n4) || w4(this.state, t4);
      }, r4;
    }(m2);
    A3 = n2.__b;
    n2.__b = function(n3) {
    ...
    k2 = function(n3, t3) {
      return n3 ? x(n3).reduce(function(n4, e4, r4) {
        return n4.concat(t3(e4, r4));
      }, []) : null;
    };
    ...
    F2 = n2.__e;
    n2.__e = function(n3, t3, e4) {
      if (n3.then) {
        for (var r4, o6 = t3; o6 = o6.__; )
          if ((r4 = o6.__c) && r4.__c)
            return r4.__c(n3, t3.__c);
      }
      F2(n3, t3, e4);
    }, (U.prototype = new m2()).__c = function(n3, t3) {
      var e4 = this;
      null == e4.o && (e4.o = []), e4.o.push(t3);
      var r4 = M2(e4.__v), o6 = false, u3 = function() {
        o6 || (o6 = true, r4 ? r4(i3) : i3());
      };
      ...
      var i3 = function() {
        var n4;
        if (!--e4.__u)
          for (e4.__v.__k[0] = e4.state.u, e4.setState({ u: e4.__b = null }); n4 = e4.o.pop(); )
            n4.forceUpdate();
      };
      e4.__u++ || e4.setState({ u: e4.__b = e4.__v.__k[0] }), n3.then(u3, u3);
    }, U.prototype.render = function(n3, t3) {
      return this.__b && (this.__v.__k[0] = N2(this.__b), this.__b = null), [h(m2, null, t3.u ? null : n3.children), t3.u && n3.fallback];
    };
    P3 = function(n3, t3, e4) {
      if (++e4[1] === e4[0] && n3.l.delete(t3), n3.props.revealOrder && ("t" !== n3.props.revealOrder[0] || !n3.l.size))
        for (e4 = n3.i; e4; ) {
          for (; e4.length > 3; )
            e4.pop()();
          if (e4[1] < e4[0])
    ...
    (O2.prototype = new m2()).u = function(n3) {
      var t3 = this, e4 = M2(t3.__v), r4 = t3.l.get(n3);
      return r4[0]++, function(o6) {
        var u3 = function() {
          t3.props.revealOrder ? (r4.push(o6), P3(t3, n3, r4)) : o6();
        };
        e4 ? e4(u3) : u3();
      };
    ...
    n2.vnode = function(n3) {
      ...
      if (t3) {
        if (e4.class != e4.className && ($2.enumerable = "className" in e4, null != e4.className && (e4.class = e4.className), Object.defineProperty(e4, "className", $2)), "function" != typeof t3) {
          var r4, o6, u3;
          for (u3 in e4.defaultValue && void 0 !== e4.value && (e4.value || 0 === e4.value || (e4.value = e4.defaultValue), delete e4.defaultValue), Array.isArray(e4.value) && e4.multiple && "select" === t3 && (x(e4.children).forEach(function(n4) {
            -1 != e4.value.indexOf(n4.props.value) && (n4.props.selected = true);
          }), delete e4.value), e4)
            if (r4 = D2.test(u3))
              break;
          if (r4)
            for (u3 in o6 = n3.props = {}, e4)
              o6[D2.test(u3) ? u3.replace(/[A-Z0-9]/, "-$&").toLowerCase() : u3] = e4[u3];
        }
        !function(t4) {
          var e5 = n3.type, r5 = n3.props;
          if (r5 && "string" == typeof e5) {
            var o7 = {};
            for (var u4 in r5)
              /^on(Ani|Tra|Tou)/.test(u4) && (r5[u4.toLowerCase()] = r5[u4], delete r5[u4]), o7[u4.toLowerCase()] = u4;
            if (o7.ondoubleclick && (r5.ondblclick = r5[o7.ondoubleclick], delete r5[o7.ondoubleclick]), o7.onbeforeinput && (r5.onbeforeinput = r5[o7.onbeforeinput], delete r5[o7.onbeforeinput]), o7.onchange && ("textarea" === e5 || "input" === e5.toLowerCase() && !/^fil|che|ra/i.test(r5.type))) {
              var i3 = o7.oninput || "oninput";
              r5[i3] || (r5[i3] = r5[o7.onchange], delete r5[o7.onchange]);
            }
          }
    ...
    compat_module_default = { useState: m3, useReducer: p3, useEffect: l3, useLayoutEffect: y2, useRef: d3, useImperativeHandle: s2, useMemo: h2, useCallback: T3, useContext: w3, useDebugValue: A2, version: "16.8.0", Children: R, render: T4, hydrate: T4, unmountComponentAtNode: Q, createPortal: z2, createElement: h, createContext: M, createFactory: G, cloneElement: K, createRef: y, Fragment: d2, isValidElement: J, findDOMNode: X, Component: m2, PureComponent: C2, memo: _3, forwardRef: S, unstable_batchedUpdates: Y, Suspense: U, SuspenseList: O2, lazy: L3 };
  }
});
...
function getErrorByCode(code) {
  const match = Object.values(STANDARD_ERROR_MAP).find((e4) => e4.code === code);
  if (!match) {
    return STANDARD_ERROR_MAP[DEFAULT_ERROR];
  }
  return match;
...
var o2 = class extends r {
  constructor(t3) {
    super(t3), this.events = new import_events.EventEmitter(), this.hasRegisteredEventListeners = false, this.connection = this.setConnection(t3), this.connection.connected && this.registerEventListeners();
  }
  ...
  async requestStrict(t3, e4) {
    return new Promise(async (i3, s3) => {
      ...
      this.events.on(`${t3.id}`, (n3) => {
        isJsonRpcError(n3) ? s3(n3.error) : i3(n3.result);
      });
      try {
...
var l = (r4, t3, e4) => t3 in r4 ? P(r4, t3, { enumerable: true, configurable: true, writable: true, value: e4 }) : r4[t3] = e4;
var p = (r4, t3) => {
  for (var e4 in t3 || (t3 = {}))
    L.call(t3, e4) && l(r4, e4, t3[e4]);
  if (c2)
    for (var e4 of c2(t3))
      O.call(t3, e4) && l(r4, e4, t3[e4]);
  return r4;
};
var v = (r4, t3) => w(r4, E(t3));
...
var f = class {
  constructor(t3, e4 = false) {
    if (this.url = t3, this.disableProviderPing = e4, this.events = new import_events2.EventEmitter(), this.isAvailable = false, this.registering = false, !isHttpUrl(t3))
  ...
  async send(t3) {
    ...
    try {
      const e4 = safeJsonStringify(t3), s3 = await (await (0, import_cross_fetch.default)(this.url, v(p({}, d), { body: e4 }))).json();
  ...
  async register(t3 = this.url) {
    ...
    if (this.registering) {
      ...
      return (this.events.listenerCount("register_error") >= e4 || this.events.listenerCount("open") >= e4) && this.events.setMaxListeners(e4 + 1), new Promise((s3, i3) => {
    ...
    try {
      if (!this.disableProviderPing) {
        ...
        await (0, import_cross_fetch.default)(t3, v(p({}, d), { body: e4 }));
      }
      this.onOpen();
    } catch (e4) {
      const s3 = this.parseError(e4);
  ...
  onError(t3, e4) {
    const s3 = this.parseError(e4), i3 = s3.message || s3.toString(), n3 = formatJsonRpcError(t3, i3);
...
var SocketTransport = class {
  ...
  _socketError(e4) {
    ...
    if (events && events.length) {
      events.forEach((event) => event.callback(e4));
    }
  }
  _queueSubscriptions() {
...
// node_modules/@walletconnect/signer-connection/dist/esm/index.js
var import_qrcode_modal = __toESM(require_cjs5());
var SignerConnection = class extends o {
  ...
  async send(payload) {
    ...
    if (!this.connected)
      await this.open();
    this.sendPayload(payload).then((res) => this.events.emit("payload", res)).catch((e4) => this.events.emit("payload", formatJsonRpcError(payload.id, e4.message)));
  }
  register(opts) {
    if (this.wc)
      return this.wc;
  ...
  create(chainId) {
    ...
    this.pending = true;
    this.registerConnectorEvents();
    this.wc.createSession({ chainId: this.chainId }).then(() => this.events.emit("created")).catch((e4) => this.events.emit("error", e4));
  }
...
***************************************************************************** */
//# sourceMappingURL=esm-K4AVWCF5.js.map
