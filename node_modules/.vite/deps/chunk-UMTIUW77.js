...
import {
  require_react_dom
} from "./chunk-PYFUVVQP.js";
import {
  require_react
} from "./chunk-JL5N4Q7Z.js";
import {
  Contract,
  init_lib,
  init_lib10,
...
var require_utils = __commonJS({
  "node_modules/ethers/lib/utils.js"(exports) {
    ...
    var basex_1 = (init_lib17(), __toCommonJS(lib_exports17));
    ...
    var hdnode_1 = (init_lib20(), __toCommonJS(lib_exports20));
    ...
    var json_wallets_1 = (init_lib22(), __toCommonJS(lib_exports22));
    ...
    var sha2_1 = (init_lib18(), __toCommonJS(lib_exports18));
    ...
    var random_1 = (init_lib21(), __toCommonJS(lib_exports21));
    ...
    var wallet_1 = (init_lib23(), __toCommonJS(lib_exports23));
    ...
    var sha2_2 = (init_lib18(), __toCommonJS(lib_exports18));
...
var require_ethers = __commonJS({
  "node_modules/ethers/lib/ethers.js"(exports) {
    ...
    var contracts_1 = (init_lib16(), __toCommonJS(lib_exports16));
    ...
    var wordlists_1 = (init_lib19(), __toCommonJS(lib_exports19));
...
var allChains = [mainnet, ropsten, rinkeby, goerli, kovan, optimism, optimismKovan, polygon, polygonMumbai, arbitrum, arbitrumRinkeby, localhost, hardhat, foundry];
var defaultChains = [mainnet, ropsten, rinkeby, goerli, kovan];
var defaultL2Chains = [arbitrum, arbitrumRinkeby, optimism, optimismKovan];
...
var Client = class {
  constructor(_ref) {
    ...
    this.store = vanilla(subscribeWithSelector(persist(() => ({
...
function parseContractResult(_ref) {
  ...
  if (data && isPlainArray(data)) {
    ...
    const iface = import_ethers2.Contract.getInterface(contractInterface);
...
function useProvider() {
  ...
  return (0, import_with_selector.useSyncExternalStoreWithSelector)((cb) => watchProvider({
    chainId: chainId2
  }, cb), () => getProvider({
    chainId: chainId2
  }), () => getProvider({
...
function useWebSocketProvider() {
  ...
  return (0, import_with_selector.useSyncExternalStoreWithSelector)((cb) => watchWebSocketProvider({
    chainId: chainId2
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-UMTIUW77.js.map
